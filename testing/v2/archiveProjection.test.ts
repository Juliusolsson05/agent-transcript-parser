...
import { claudeArchiveProjector, projectClaudeArchive } from '../../src/v2/claude/project/index.js'
...
import type { ArchiveProjector } from '../../src/v2/projection/types.js'
  ...
  it('projects the neutral protocol into Codex without importing Claude shapes', () => {
    ...
    expect(result.values[0]).toEqual({
      ...
      payload: {
        id: 'codex-target',
        timestamp: now,
        source: 'agent-transcript-parser-v2-archive',
